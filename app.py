...
# an object of wsgi app
app = Flask(__name__)
model = pickle.load(open(r"C:\Users\pooja_dj\PycharmProjects\flaskProject1\file.pkl", 'rb'))

# route() decorator, to bind the URL to a function.
...
# this works when the user click the prediction button
...
# render template methode render(takes) HTML data which will display in the user’s browser
        return render_template('index.html')
